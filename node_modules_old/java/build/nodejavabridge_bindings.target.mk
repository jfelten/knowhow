...
quiet_cmd_nodejavabridge_bindings_verifyDeps = ACTION Verify Deps $@
cmd_nodejavabridge_bindings_verifyDeps = export LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; cd $(srcdir)/.; mkdir -p ./build; 
...
build/depsVerified: /usr/lib/jvm/java-1.6.0-openjdk.x86_64/jre/lib/amd64/server/libjvm.so /usr/lib/jvm/java-1.6.0-openjdk.x86_64/include/jni.h /usr/lib/jvm/java-1.6.0-openjdk.x86_64/include/linux/jni_md.h FORCE_DO_CMD
	$(call do_cmd,nodejavabridge_bindings_verifyDeps)

all_deps += build/depsVerified
action_nodejavabridge_bindings_verifyDeps_outputs := build/depsVerified
...
INCS_Debug := -I/usr/include \
	-I/usr/include/node \
	-I/usr/lib/jvm/java-1.6.0-openjdk.x86_64/include \
	-I/usr/lib/jvm/java-1.6.0-openjdk.x86_64/include/linux
...
$(OBJS): | $(action_nodejavabridge_bindings_verifyDeps_outputs)
...
$(obj).target/nodejavabridge_bindings.node: | $(action_nodejavabridge_bindings_verifyDeps_outputs)

# Preserve order dependency of special output on deps.
$(action_nodejavabridge_bindings_verifyDeps_outputs): | 
...
LIBS := -L/usr/lib/jvm/java-1.6.0-openjdk.x86_64/jre/lib/amd64/server/ \
	-Wl,-rpath,/usr/lib/jvm/java-1.6.0-openjdk.x86_64/jre/lib/amd64/server/ \
	-ljvm
